          ...
          <form id="formulario_registro">
            ...
            <fieldset>
              ...
              <div class="input-group">
                ...
                <input type="password" autocomplete="off" class="form-control" name="clave" placeholder="Ingresar contraseña">
              </div>
              ...
              <div class="input-group">
                <div class="input-group-addon"><i class="fa fa-lock"></i></div>
                <input type="password" autocomplete="off" class="form-control" name="clave2" placeholder="Confirmar contraseña">
              </div>
